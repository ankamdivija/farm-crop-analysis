...
logistic_regression_model_softmax = LogisticRegression(multi_class='multinomial',solver='lbfgs',max_iter=1500)
logistic_regression_model_softmax.fit(X_train,y_train)

pickle.dump(logistic_regression_model_softmax, open("logistic.pkl", "wb"))